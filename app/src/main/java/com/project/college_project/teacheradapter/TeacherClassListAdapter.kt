...
import com.project.college_project.teacher.AddInsideClass
...
class TeacherClassListAdapter (
    ...
    RecyclerView.Adapter<TeacherClassListAdapter.BloodListViewHolder>() {
    ...
    override fun onBindViewHolder(holder: BloodListViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            val intent = Intent(ctx, AddInsideClass::class.java)
